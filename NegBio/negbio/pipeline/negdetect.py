...
from NegBio.negbio.neg.neg_detector import Detector
    ...
    try:
        ...
        for passage in document.passages:
            ...
            for ann in passage.annotations:
                ...
                #     continue
                loc = ann.locations[0] # Compatible with bioc==2.1, use ann.location[0]
                locs.append((loc.offset, loc.offset + loc.length))
