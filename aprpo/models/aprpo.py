...
from aprpo.models.qwen2_5_vl import Qwen2_5_VLForConditionalGeneration
from qwen_vl_utils import process_vision_info
from aprpo.models.base_model import BaseModel
from peft import get_peft_model, LoraConfig
from aprpo.models.med_visual_encoder import build_vit_b_CXR_mae_CheXpert
from aprpo.models.outputs import Output

# APRPO Stage 3 RL
@registry.register_model("APRPO_stage3")
class APRPO_stage3(BaseModel): 
    """
    APRPO Stage 3 Model
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "APRPO": "configs/models/APRPO.yaml" 
    }
...
# APRPO Stage 2 Classifier-Guided SFT 
@registry.register_model("APRPO_stage2")
class APRPO_stage2(BaseModel): 
    """
    APRPO Stage 2 Model
...
# APRPO Stage 1 Warmup
@registry.register_model("APRPO_stage1")
class APRPO_stage1(BaseModel): 
    """
    APRPO Stage 1 Model
