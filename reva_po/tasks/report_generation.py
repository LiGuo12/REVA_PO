...
from reva_po.tasks.base_task import BaseTask
from reva_po.common.logger import MetricLogger, SmoothedValue
from reva_po.datasets.data_utils import prepare_sample
from reva_po.common.dist_utils import is_dist_avail_and_initialized, main_process, is_main_process
...
class XrayReportGenerate(BaseTask):
    ...
    def compute_metrics(self, predictions, ground_truths):
        ...
        gts = {}  # ground truth
        res = {}  # predictions
        valid_pairs = []  # (pred, gt) only for valid_samples
        valid_samples = 0
        empty_samples = 0
