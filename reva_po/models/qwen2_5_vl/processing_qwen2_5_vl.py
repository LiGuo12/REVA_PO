...
class Qwen2_5_VLProcessor(ProcessorMixin):
    ...
    def __init__(self, image_processor=None, tokenizer=None, chat_template=None, **kwargs):
        ...
        # self.retrieved_image_token = "<|retrieved_image_pad|>" if not hasattr(tokenizer, "retrieved_image_token") else tokenizer.retrieved_image_token
    ...
    def __call__(
        ...
        **kwargs: Unpack[Qwen2_5_VLProcessorKwargs],
        ...
        # if retrieved_image_grid_thw is not None:
        #     merge_length = self.image_processor.merge_size**2
        #     index = 0
        #     for i in range(len(text)):
        #         while self.retrieved_image_token in text[i]:
        #             text[i] = text[i].replace(
        #                 self.retrieved_image_token,
        #                 "<|placeholder|>" * (retrieved_image_grid_thw[index].prod() // merge_length),
        #                 1,
        #             )
        #             index += 1
        #         text[i] = text[i].replace("<|placeholder|>", self.retrieved_image_token)
